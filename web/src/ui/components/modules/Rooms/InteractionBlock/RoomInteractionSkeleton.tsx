...
export default function RoomInteractionSkeleton() {
  return (
    <div className="flex flex-col w-full h-full animate-pulse">
      <div
        className="border-b border-surface-tertiary/80 flex flex-row items-center justify-between py-2 px-3 mb-2
          shrink-0"
      >
        <div className="size-6 bg-background/80 rounded" />
      ...
      <div className="mb-2 shrink-0 w-full">
        <div className="h-[38px] w-full bg-surface/80 rounded-md" />
      </div>

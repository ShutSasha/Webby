  ...
  return (
    <div className="flex flex-col h-full px-1 animate-pulse">
      <div className="flex flex-col gap-5">
        {/* Title */}
        <div className="h-3 w-24 bg-neutral-800/80 rounded ml-1" />

        {/* Room Name Input Skeleton */}
        <div className="flex flex-col gap-1.5">
          <div className="h-3.5 w-20 bg-neutral-800/80 rounded ml-1" />
          <div className="h-[42px] w-full bg-neutral-800/50 rounded-xl" />
        </div>

        {/* Room Privacy Dropdown Skeleton */}
        <div className="flex flex-col gap-1.5">
          <div className="h-3.5 w-24 bg-neutral-800/80 rounded ml-1" />
          <div className="h-[42px] w-full bg-neutral-800/50 rounded-xl" />
        </div>
      </div>

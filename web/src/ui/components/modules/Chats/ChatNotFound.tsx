...
export function ChatNotFound() {
  return (
    <div className="flex flex-col h-full w-full items-center justify-center text-neutral-500 bg-neutral-900/5">
      ...
      <h3 className="text-xl font-semibold text-neutral-300">Chat Not Found</h3>
      <p className="text-sm mt-2 text-center max-w-[300px]">This chat may have been deleted or does not exist.</p>
      <Link
        href="/chats"
        className="mt-6 px-4 py-2 bg-neutral-800 hover:bg-neutral-700 text-neutral-200 rounded-xl transition-colors
          text-sm font-medium"
      >
        Back to Chats
      </Link>

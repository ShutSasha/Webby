...
export function ChatNotFound() {
  return (
    <div className="flex flex-col h-full w-full items-center justify-center text-foreground-faint bg-surface/5">
      ...
      <Link
        href="/chats"
        className="mt-6 px-4 py-2 bg-background hover:bg-surface-tertiary text-foreground-tertiary rounded-xl

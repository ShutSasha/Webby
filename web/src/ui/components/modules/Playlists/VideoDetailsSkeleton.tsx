export default function VideoDetailsSkeleton() {
  return (
    <div className="h-fit min-w-0 w-full animate-pulse">
      {/* Player */}
      <div className="w-full aspect-video bg-neutral-800 rounded-2xl" />
      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        ...
        <div className="flex gap-3 items-center">
          <div className="h-9 w-36 bg-neutral-800 rounded-full" />
          <div className="h-9 w-[150px] bg-neutral-800 rounded-full" />
        </div>
      </div>

      {/* Description Area */}
      <div className="flex flex-col gap-2 rounded-xl bg-neutral-800/40 p-3 mt-4 overflow-hidden">
        {/* Views & Date */}
        <div className="h-5 w-40 bg-neutral-700/50 rounded-md" />

        {/* Description Text */}
        <div className="h-[69px] w-full bg-neutral-700/50 rounded-md" />
      </div>
    </div>
  )
}

...
type MemberExistsRequest struct {
...
func (x *MemberExistsRequest) String() string {
...
func (x *MemberExistsRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
type MemberExistsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MemberExistsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_member_member_proto_rawDesc = "" +
	"\n" +
	"\x13member/member.proto\x12\x06member\"E\n" +
	...
	"\fMemberExists\x12\x1b.member.MemberExistsRequest\x1a\x1c.member.MemberExistsResponseB+Z)webby-vote-service/internal/grpc/memberpbb\x06proto3"

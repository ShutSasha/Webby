...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/docs.ApiResponse-docs_CategoryResponse"
                        }
                    },
                    "400": {
                    ...
                    "409": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/docs.Error409Response"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
                ...
                "parameters": [
                    {
                        ...
                        "minLength": 2,
                        "type": "string",
                        "description": "Room name (2-50 chars, required, non-whitespace)",
                        "name": "name",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Visibility flag (required): 'true' or 'false'",
                        "name": "isPrivate",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "file",
                        "description": "Room thumbnail image (optional, max 2MB)",
                        "name": "thumbnail",
                        "in": "formData"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/docs.ApiResponse-PaginatedResponse[RoomListItem]"
                        }
                    },
                    "400": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "minLength": 2,
                        "type": "string",
                        "description": "Room name (2-50 chars, required)",
                        "name": "name",
                        "in": "formData",
                        "required": true
                    },
                    ...
                    {
                        "type": "string",
                        "description": "Visibility flag ('true' or 'false', required)",
                        "name": "isPrivate",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "file",
                        "description": "New thumbnail image (optional, max 2MB)",
                        "name": "thumbnail",
                        "in": "formData"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/docs.ApiResponse-PaginatedResponse[RoomMemberItem]"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/docs.AddQueueItemRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/docs.ApiResponse-docs_QueueItemResponse"
                        }
                    },
                    "400": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/docs.ApiResponse-any"
                        }
                    },
                    "400": {
                        "description": "Invalid UUID format in path",
    ...
    "definitions": {
        ...
        "docs.ApiResponse-PaginatedResponse[RoomMemberItem]": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/docs.PaginatedResponse-docs_RoomMemberItem"
                },
                "errors": {
                    "type": "string",
                    "x-nullable": true,
        ...
        "docs.ApiResponse-docs_QueueItemResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/docs.QueueItemResponse"
                },
                "errors": {
                    "type": "string",
                    "x-nullable": true,
        ...
        "docs.PaginatedResponse-docs_RoomListItem": {
            ...
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/docs.RoomListItem"
                    }
                },
                "limit": {
                    "type": "integer",
        ...
        "docs.PaginatedResponse-docs_RoomMemberItem": {
            ...
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/docs.RoomMemberItem"
                    }
                },
                "limit": {
                    "type": "integer",
        ...
        "docs.QueueItemDetailResponse": {
            ...
            "properties": {
                "children": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/docs.QueueVideoChild"
                    }
                },
                "entityId": {
                    "type": "string",

...
func (_m *MockLister) List(search string, page int, limit int) ([]models.Category, int64, error) {
...
//   - page int
//   - limit int
func (_e *MockLister_Expecter) List(search interface{}, page interface{}, limit interface{}) *MockLister_List_Call {
	return &MockLister_List_Call{Call: _e.mock.On("List", search, page, limit)}
}

func (_c *MockLister_List_Call) Run(run func(search string, page int, limit int)) *MockLister_List_Call {
...
func (_c *MockLister_List_Call) RunAndReturn(run func(string, int, int) ([]models.Category, int64, error)) *MockLister_List_Call {
	_c.Call.Return(run)
	return _c
}

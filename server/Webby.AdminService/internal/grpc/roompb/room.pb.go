...
const file_proto_room_room_proto_rawDesc = "" +
	"\n" +
	"\x15proto/room/room.proto\x12\x04room\x1a\x1bgoogle/protobuf/empty.proto\"7\n" +
	"\x15GetTotalRoomsResponse\x12\x1e\n" +
	"\n" +
	"totalRooms\x18\x01 \x01(\x05R\n" +
	"totalRooms2W\n" +
	"\x0fRoomGrpcService\x12D\n" +
	"\rGetTotalRooms\x12\x16.google.protobuf.Empty\x1a\x1b.room.GetTotalRoomsResponseB*Z(webby/admin-service/internal/grpc/roompbb\x06proto3"
...
var file_proto_room_room_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_room_room_proto_goTypes = []any{
	(*GetTotalRoomsResponse)(nil), // 0: room.GetTotalRoomsResponse
	(*emptypb.Empty)(nil),         // 1: google.protobuf.Empty
}
var file_proto_room_room_proto_depIdxs = []int32{
	1, // 0: room.RoomGrpcService.GetTotalRooms:input_type -> google.protobuf.Empty
	0, // 1: room.RoomGrpcService.GetTotalRooms:output_type -> room.GetTotalRoomsResponse
